...
public class SolParser extends Parser {
	...
	public static final int
		...
		RULE_var = 5, RULE_block = 6, RULE_typeFunction = 7, RULE_type = 8, RULE_while = 9, 
		RULE_for = 10, RULE_if = 11;
	private static String[] makeRuleNames() {
		return new String[] {
			"prog", "function", "line", "inst", "assignInst", "var", "block", "typeFunction", 
			"type", "while", "for", "if"
		};
	}
	...
	public final TypeFunctionContext typeFunction() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_typeFunction);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
